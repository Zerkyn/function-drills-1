...
//CODE HERE
const add = (a, b) => {
  let aParse = parseInt(a)
  let bParse = parseInt(b)
...
console.log(exclaimThree('beep boop'))
...
const emailCheck = (email) => {
  ...
  } else return 'must provide a valid email adress'
}
console.log(emailCheck('   bob@gmail.com'))
...
const chocolateFrogs = (gold) => {
  let frogs = gold / 3 //Math.floor(gold / 3) 
  return frogs
}
const totalFrogs = chocolateFrogs(10)
...
const totalFrogs2 = chocolateFrogs2(10)
